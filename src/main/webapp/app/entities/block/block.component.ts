...
export class BlockComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.blockService
      ...
      .subscribe(
        (res: HttpResponse<IBlock[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInBlocks(): void {
    this.eventSubscriber = this.eventManager.subscribe('blockListModification', () => this.loadPage());
  }
